...
class WallFollower(Node):
    def __init__(self):
        ...
        self.left_dist = 9999999.9  # Intialisiere den Variable auf einen ungueltigen Wert
    ...
    def timer_callback(self):
        if self.valid_lidar_data: #Beim erstmaligen Aufrfug liegen noch keine LiDAR Daten vor
            self.follow_wall()
    ...
    def follow_wall(self):
        ...
        if self.wallfollower_state == WallFollowerStates.WF_STATE_INVALID:
            ...
            #Drehe Roboter solagen bis auf der X-Achse der Mindestabstand erscheint
